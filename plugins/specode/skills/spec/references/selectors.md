---
description: Use when tasks.md is complete and you need to present the "execution mode" selector to the user — verbatim AskUserQuestion example for specode lite's single fixed selector.
---
